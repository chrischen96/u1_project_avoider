...
function init() {
    ...
    playerCells[2].innerHTML = `<div class="player"><svg xmlns="http://www.w3.org/2000/svg" width="calc(66vh / ${col})" height="calc(66vh / ${col})" fill="currentColor" class="bi bi-airplane-engines-fill" viewBox="0 0 16 16">
...
function drop() {
    ...
    for (let i = enemyCells.length - 1; i >= 0; i--) {
        ...
        if (playerCells.includes(nextCell)) {
            if (nextCell.querySelector('.player')) {
                gameOver = true
                document.querySelector('.player').innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="calc(66vh / ${col})" height="calc(66vh / ${col})" fill="currentColor" class="bi bi-heartbreak-fill" viewBox="0 0 16 16">
    ...
    if (dropCount % 2 === 0) {
        ...
        enemyCells[position].innerHTML = `<div class='enemy'><svg xmlns="http://www.w3.org/2000/svg" width="calc(60vh / ${col})" height="calc(60vh / ${col})" fill="currentColor" class="bi bi-airplane-engines" viewBox="0 0 16 16">
